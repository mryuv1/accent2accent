...
class AccentHuggingBased(Dataset):
    def __init__(self,data_type="train",batch_size=2,SlowRun=True,limit_samples=5000,enable_multiprocessing=True,TzlilTrain=False,VGGish=False):
...
class AccentHuggingBasedDataLoader(pl.LightningDataModule):
    ...
    def add_argparse_args(parent_parser):
        ...
        return parser
    def __init__(self, batch_size=32,include_India=False,include_newdataset=False, SlowRun=False,TzlilTrain=False,**_):
        super().__init__()
    ...
    def train_dataloader(self):
        ...
        return DataLoader(AccentHuggingBased(batch_size=self.batch_size, data_type="train",SlowRun=self.SlowRun, TzlilTrain=self.TzlilTrain), batch_size=1,shuffle=True, num_workers=4)

    def val_dataloader(self):
        return DataLoader(AccentHuggingBased(data_type="test",batch_size=self.batch_size,SlowRun=self.SlowRun, TzlilTrain=self.TzlilTrain), batch_size=1, shuffle=False)
